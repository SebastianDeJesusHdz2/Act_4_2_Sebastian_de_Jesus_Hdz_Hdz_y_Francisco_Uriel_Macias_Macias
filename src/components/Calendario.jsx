...
const imgLeft = 'https://www.figma.com/api/mcp/asset/ba080159-d0c1-45c0-9743-63dae121359b'
const imgRight = 'https://www.figma.com/api/mcp/asset/ea9a5995-4ee0-42dd-9861-6980b35ac25f'
const imgLeftDark = 'https://www.figma.com/api/mcp/asset/88d829fa-a42a-4076-bed8-97ff5d61cf09'
const imgRightDark = 'https://www.figma.com/api/mcp/asset/6ea50196-b626-4364-af64-206a5774c19b'
...
function Calendario({ modo = 'light' }) {
  ...
  return (
    <div className={`calendario-contenedor ${esDark ? 'calendario-dark' : 'calendario-light'}`}>
